...
## 📊 Platform-wise Problem Solving Summary

| Platform      | Total Problems Solved | Last Updated | Status        | Link                     |
| ------------- | --------------------- | ------------ | ------------- | ------------------------ |
| GeeksforGeeks | 40                    | 2025-11-14   | ✅ Active     | [View](./geeksforgeeks/) |
...
│   ├── w[n]-p[n]-promlem-name-*/
│   └── ...
├── leetcode/          # LeetCode problems
│   ├── problem-name/
│   └── ...
└── hackerrank/        # HackerRank problems
    ├── w[n]-p-[n]-problem-name-*/
    └── ...
```
...
Each problem directory adheres to a consistent, scalable structure designed for long-term maintainability and analytics.

| File / Folder    | Purpose / Description                                                                                                                                                                         |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Solution.[ext]` | Core implementation file (supports multiple languages such as `.py`, `.js`, `.cpp`, etc.)                                                                                                     |
| `README.md`      | Standardized problem documentation including:<br>• Problem Title & Platform<br>• Category & Difficulty<br>• Problem Statement<br>• Solution Approach<br>• Complexity Analysis<br>• Test Cases |
| `meta.json`      | Machine-readable metadata for automation, indexing, and analytics.                                                                                                                            |
...
- [ ] Add more problems from GeeksforGeeks, LeetCode and HackerRank
